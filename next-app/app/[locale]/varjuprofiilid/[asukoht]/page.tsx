...
const CONFIG: Record<Asukoht, { titleEt: string; titleRu: string; h1Et: string; h1Ru: string; descEt: string; descRu: string; eyebrowEt: string; eyebrowRu: string }> = {
  lae: {
    titleEt: 'Lae varjuprofiilid – alumiinium shadow gap laele | Varjuprofiilid.ee',
    titleRu: 'Потолочные теневые профили – алюминиевый shadow gap | Varjuprofiilid.ee',
    h1Et: 'Lae varjuprofiilid – alumiinium shadow gap laele',
    h1Ru: 'Потолочные теневые профили – алюминиевый shadow gap',
  ...
  seina: {
    titleEt: 'Seina varjuprofiilid – shadow gap seinale | Varjuprofiilid.ee',
    titleRu: 'Настенные теневые профили – shadow gap для стен | Varjuprofiilid.ee',
    h1Et: 'Seina varjuprofiilid – dekoratiivsed shadow gap profiilid',
    h1Ru: 'Настенные теневые профили – декоративный shadow gap',
  ...
  poranda: {
    titleEt: 'Põranda varjuprofiilid – dekoratiivsed põrandaliistude alternatiivid | Varjuprofiilid.ee',
    titleRu: 'Напольные теневые профили – декоративные альтернативы плинтусам | Varjuprofiilid.ee',
