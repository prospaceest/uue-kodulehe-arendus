...
const POSTS: Record<string, {
  ...
  'varjuprofiil-vannituppa': {
    titleEt: "Kas varjuprofiil sobib vannituppa? Niiskus, korrosioon ja IP-klass",
    titleRu: "Подходит ли теневой профиль для ванной? Влага, коррозия и класс IP",
    catEt: "Juhend", catRu: "Руководство",
    yearEt: '2026 · juuli', yearRu: '2026 · июль',
    read: "7 min",
    cover: '/assets/projects/projekt03.webp',
    excerptEt: "Vannituba on maja kõige niiskem ruum. Vaatame üle, millal alumiinium varjuprofiil sinna sobib, mis vahe on kuival ja märjal tsoonil ning miks LED-i IP-klass on kriitiline.",
    excerptRu: "Ванная — самое влажное помещение в доме. Разбираем, когда алюминиевый теневой профиль туда подходит, чем отличается сухая зона от мокрой и почему класс IP светодиода критичен.",
    bodyEt: "Vannituba tundub varjuprofiili jaoks riskantne koht: pidev niiskus, temperatuurikõikumised ja veepritsmed. Enamik neist muredest lahenevad materjalivalikuga ja LED-komponentide õige IP-klassiga. Alumiinium ise ei ole vannitoas probleem — probleem on täitematerjal ja valgustuse veekindlus. Vaatame läbi, mis vannitoas tegelikult loeb.\n\n## Alumiinium ja korrosioon\n\nMeie varjuprofiilid on valmistatud alumiiniumist. Alumiinium moodustab õhu käes õhukese oksiidkihi, mis kaitseb metalli edasise korrosiooni eest — see teeb temast vannituppa oluliselt sobivama kui teraskomponendid, mis roostetavad. Anodeeritud pinnaga mudelitel on see kaitsekiht veel tugevam. Näiteks põrandaliist ASP40 on anodeeritud kattekihiga, mis annab kõrgema pinnatugevuse ja parema vastupidavuse niiskele keskkonnale.\n\nOluline vahe: **\"anodeeritud hõbe\" on meie kataloogis värvi nimi** (anodeeritud välimusega toon), mitte tingimata protsessi kirjeldus. Kui vannitoa jaoks on oluline maksimaalne pinnatugevus, tasub tellimisel täpsustada, milline mudel on tegelikult anodeeritud kattega.\n\n## Kuiv tsoon vs märg tsoon\n\nVannituba jaguneb tsoonideks ja varjuprofiili sobivus sõltub sellest, kuhu see paigaldatakse.\n\n- **Kuiv tsoon** — lagi (välja arvatud otse duši kohal), seinad eemal veeallikast, ukse lähedus. Siia sobib enamik lae varjuprofiile probleemideta.\n- **Märg tsoon** — duširuum, vanni ümbrus, otsesed pritsmealad. Siia paigaldatav profiil ja eriti LED peavad taluma niiskust ja vett.\n\nEnamikus vannitubades paigaldatakse dekoratiivne varjujoon just kuiva tsooni: lae ja seina ühenduskohta üle valamu või peegli. Selleks sobivad hästi klassikalised mudelid nagu **AST22 (lae LED varjuprofiil)** või peenem **AST14_12**. Kui LED-i pole vaja, annab puhta arhitektuurse varjujoone LED-vabalt **AST10** või ülipeen **LPA126 (6 mm lae varjuprofiil)** — viimane töötab hästi peitliist / laesiin lahendusena, kus soovitakse ainult joont, mitte valgust.\n\n## LED ja IP-klass — kõige olulisem otsus\n\nSee on koht, kus vannitoa projekt kõige sagedamini eksib. Standardne LED-riba on mõeldud kuiva keskkonda. Vannitoas — eriti märjas tsoonis — tuleb kasutada niiskuskindlat LED-riba sobiva IP-klassiga:\n\n- **Kuiv tsoon** (lagi üle valamu, seinad eemal veest): tavaline riba on enamasti piisav, kuid vannitoa üldniiskuse tõttu soovitame vähemalt IP44 taset.\n- **Märg tsoon** (duš, vanni ümbrus): siin on IP65 või kõrgem tegelikult vajadus, mitte soovitus. Vesi ja aur ei tohi pääseda LED-riba kontaktideni.\n\nMeie lae LED-riba standard on **12 W/m · 234 LED/m · 3000K · 24V**. 24V süsteem on vannitoas ohutum kui 230V otseühendus, kuna madalpinge vähendab riski. Kindlasti tuleb kasutada hajutit — näiteks **ASL300** või **ASL302** —, et LED-täpid sulanduks ühtlaseks varjujooneks; hajuti aitab ka valgusallikat niiskuse eest paremini varjata.\n\nToiteplokk ja ühendused **ei tohi kunagi asuda märjas tsoonis**. Need paigaldatakse kuiva ruumi ossa või ligipääsetavasse tehnilisse nišši.\n\n## Miks MDF-täide vannituppa ei sobi\n\nMõnede paigalduslahenduste puhul kasutatakse profiili ümber MDF- või puitpõhist täitematerjali. **Vannituppa see ei sobi.** MDF paisub niiskuse käes, kaotab mõõdud ja hakkab servadest lagunema — tulemus on nähtav juba esimese kütteperioodi järel. Vannitoas peab profiili ümbritsev konstruktsioon olema niiskuskindel: niiskuskindel kipsplaad (roheline plaat), tsementplaat või muu veekindel aluspind. Varjuprofiil ise paigaldatakse **kipsplaadi alla** nii, et pahteldatav serv sulandub veekindla pinnaga.\n\nSüvistatavate mudelite puhul, nagu **AST45 (lae süvis-LED varjuprofiil)**, on eriti oluline, et pahteldatav serv liituks korralikult niiskuskindla plaadiga — vastasel juhul pääseb niiskus liite kaudu konstruktsiooni.\n\n## Põrand ja seina üleminek\n\nVannitoa põrandal on veekindlus juba plaatimise ja hüdroisolatsiooniga lahendatud, mistõttu klassikalist LED-põrandaprofiili märga tsooni tavaliselt ei paigaldata. Kuival alal — näiteks pesumasina nišis või vannitoa eesruumis — sobib põranda LED varjuprofiil **ASP102** või kompaktne **ASP238** hästi. Põranda/seina LED-riba on tugevam: **COB 16 W/m · 1350 lm/m · CRI 94 · 24V**, mis annab ühtlasema joone ka lühemal kõrgusel. Märja tsooni puhul kehtib sama IP-reegel mis laes.\n\n## Praktilised soovitused\n\n- Planeeri LED-i IP-klass tsooni järgi juba enne ostmist — hilisem vahetus tähendab lahtivõtmist.\n- Väldi MDF- ja puittäidet; kasuta niiskuskindlat aluspinda.\n- Paigalda toiteplokk kuiva tsooni.\n- Kasuta hajutit ühtlase varjuefekti ja parema kaitse saavutamiseks.\n- Kaalu anodeeritud pinnaga mudelit, kui profiil paikneb niiskuse lähedal.\n\nVarjuprofiil sobib vannituppa igati — tingimusel, et LED-komponentide veekindlus ja täitematerjal on õigesti valitud. Kui soovid oma vannitoa plaani läbi arutada ja näha profiile ning hajuteid päriselt käes, tule meie salongi **Vana-Kalamaja 8, Tallinn**, või kirjuta **info@prospace.ee** — aitame valida tsoonile sobiva mudeli ja LED-lahenduse.",
    bodyRu: "Ванная кажется рискованным местом для теневого профиля: постоянная влажность, перепады температуры и брызги воды. Большинство этих проблем решается выбором материала и правильным классом IP светодиодных компонентов. Сам алюминий в ванной не проблема — проблема в материале заполнения и водостойкости освещения. Разберём, что в ванной действительно имеет значение.\n\n## Алюминий и коррозия\n\nНаши теневые профили изготовлены из алюминия. На воздухе алюминий образует тонкий оксидный слой, защищающий металл от дальнейшей коррозии — это делает его значительно более подходящим для ванной, чем стальные компоненты, которые ржавеют. У моделей с анодированной поверхностью этот защитный слой ещё прочнее. Например, напольный плинтус ASP40 имеет анодированное покрытие, обеспечивающее более высокую прочность поверхности и лучшую стойкость во влажной среде.\n\nВажный нюанс: **\"анодированное серебро\" в нашем каталоге — это название цвета** (оттенок с анодированным видом), а не обязательно описание процесса. Если для ванной важна максимальная прочность поверхности, при заказе стоит уточнить, какая модель действительно имеет анодированное покрытие.\n\n## Сухая зона против мокрой зоны\n\nВанная делится на зоны, и пригодность теневого профиля зависит от того, куда он устанавливается.\n\n- **Сухая зона** — потолок (кроме зоны прямо над душем), стены вдали от источника воды, зона у двери. Сюда без проблем подходит большинство потолочных теневых профилей.\n- **Мокрая зона** — душевая, зона вокруг ванны, участки прямых брызг. Устанавливаемый сюда профиль и особенно светодиод должны выдерживать влагу и воду.\n\nВ большинстве ванных декоративная теневая линия монтируется именно в сухую зону: на стык потолка и стены над раковиной или зеркалом. Для этого хорошо подходят классические модели, такие как **AST22 (потолочный светодиодный теневой профиль)** или более тонкий **AST14_12**. Если светодиод не нужен, чистую архитектурную теневую линию без света даёт **AST10** или сверхтонкий **LPA126 (потолочный теневой профиль 6 мм)** — последний хорошо работает как решение скрытого молдинга / потолочной шины, где нужна только линия, а не свет.\n\n## Светодиод и класс IP — самое важное решение\n\nЭто место, где проект ванной чаще всего ошибается. Стандартная светодиодная лента предназначена для сухой среды. В ванной — особенно в мокрой зоне — нужно использовать влагостойкую ленту с подходящим классом IP:\n\n- **Сухая зона** (потолок над раковиной, стены вдали от воды): обычной ленты чаще всего достаточно, но из-за общей влажности ванной рекомендуем как минимум уровень IP44.\n- **Мокрая зона** (душ, зона вокруг ванны): здесь IP65 или выше — это уже необходимость, а не рекомендация. Вода и пар не должны достигать контактов ленты.\n\nНаш стандарт потолочной светодиодной ленты — **12 Вт/м · 234 LED/м · 3000K · 24V**. Система 24V в ванной безопаснее прямого подключения 230V, поскольку низкое напряжение снижает риск. Обязательно использовать рассеиватель — например, **ASL300** или **ASL302** — чтобы точки светодиодов сливались в ровную теневую линию; рассеиватель также лучше защищает источник света от влаги.\n\nБлок питания и соединения **никогда не должны находиться в мокрой зоне**. Их устанавливают в сухой части помещения или в доступной технической нише.\n\n## Почему заполнение из МДФ не подходит для ванной\n\nВ некоторых решениях монтажа вокруг профиля используется заполнение из МДФ или на основе дерева. **Для ванной это не подходит.** МДФ разбухает от влаги, теряет размеры и начинает разрушаться по краям — результат виден уже после первого отопительного сезона. В ванной конструкция вокруг профиля должна быть влагостойкой: влагостойкий гипсокартон (зелёный лист), цементная плита или другое водостойкое основание. Сам теневой профиль монтируется **под гипсокартон** так, чтобы шпаклюемый край сливался с водостойкой поверхностью.\n\nДля встраиваемых моделей, таких как **AST45 (потолочный встраиваемый светодиодный теневой профиль)**, особенно важно, чтобы шпаклюемый край плотно соединялся с влагостойкой плитой — иначе влага проникнет в конструкцию через стык.\n\n## Пол и переход к стене\n\nНа полу ванной водостойкость уже решена облицовкой и гидроизоляцией, поэтому классический светодиодный напольный профиль в мокрую зону обычно не ставят. В сухой зоне — например, в нише стиральной машины или в прихожей ванной — хорошо подойдёт напольный светодиодный теневой профиль **ASP102** или компактный **ASP238**. Напольная/настенная светодиодная лента мощнее: **COB 16 Вт/м · 1350 лм/м · CRI 94 · 24V**, что даёт более ровную линию даже при меньшей высоте. Для мокрой зоны действует то же правило IP, что и на потолке.\n\n## Практические рекомендации\n\n- Планируйте класс IP светодиода по зоне ещё до покупки — последующая замена означает демонтаж.\n- Избегайте заполнения из МДФ и дерева; используйте влагостойкое основание.\n- Устанавливайте блок питания в сухой зоне.\n- Используйте рассеиватель для ровного теневого эффекта и лучшей защиты.\n- Рассмотрите модель с анодированной поверхностью, если профиль расположен вблизи влаги.\n\nТеневой профиль вполне подходит для ванной — при условии, что водостойкость светодиодных компонентов и материал заполнения выбраны правильно. Если хотите обсудить план своей ванной и увидеть профили и рассеиватели вживую, приходите в наш салон **Vana-Kalamaja 8, Таллин**, или напишите на **info@prospace.ee** — поможем подобрать подходящую зоне модель и светодиодное решение.",
  },
